...
| Order | Line | Quad | Hex | Triangle | Tet | Wedge |
| --- | --- | --- | --- | --- | --- | --- |
| 1 | 2 | 4 | 8 | 3 | 4 | 6 |
| 2 | 3 | 9 | 27 | 6 | 10 | 18 |
| 3 | 4 | 16 | 64 | 10 | 20 | 40 |
...
- **Lines, quadrilaterals, hexahedra**: tensor products of Lagrange polynomials
  ...
  Lagrange (not serendipity) elements [2]. Order 0 is one constant function with
...
element codes. Higher orders follow the same rules.
